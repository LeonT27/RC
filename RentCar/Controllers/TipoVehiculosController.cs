...
namespace RentCar.Controllers
{
    public class TipoVehiculosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Descripcion,Estado")] TipoVehiculo tipoVehiculo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Descripcion,Estado")] TipoVehiculo tipoVehiculo)
        {
            if (ModelState.IsValid)
            {
